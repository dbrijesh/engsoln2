...
public class HelloController {
    ...
    public ResponseEntity<HelloResponse> hello(Authentication authentication) {
        log.info("Hello endpoint called by user: {}", authentication.getName());
    ...
    @Operation(summary = "Public health check", description = "Public endpoint for health verification")
